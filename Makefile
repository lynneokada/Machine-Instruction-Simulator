...
#Link command:
server : mis.o Variable.o Math.o String.o Char.o Numeric.o Real.o Jump.o MISMain.o Server.o TCPSocket.o TCPServerSocket.o ClientThread.o WorkerThread.o
	$(GPP) $(GPPFLAGS) mis.o Variable.o Math.o String.o Char.o ClientThread.o WorkerThread.o \
...
mis.o: mis.cpp Variable.h Math.h String.h Char.h Numeric.h Real.h ClientThread.h WorkerThread.h
...
ClientThread.o: ClientThread.cpp ClientThread.h mis.h
WorkerThread.o: WorkerThread.cpp WorkerThread.h mis.h
